...
fn _isBaseCellPolarPentagon(baseCell: i8) -> bool {
 ...
 */
fn _baseCellToFaceIjk(baseCell: i8, h: &mut FaceIJK) {
 ...
 */
fn _baseCellToCCWrot60(baseCell: i8, face: i8) -> i8 {
